    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int row = 0; row < grades.GetLength(0); row++) //getlength for rows 
            {
                ...
                {
                    Console.Write("indtast karaktere for klasse {0}   {1} elev = ", row+1, col+1); // making our user input the number en rows and coloums 
            ...
            Console.WriteLine("gennemsnittet for første klasse er: " + avg/20);

            Console.WriteLine("gennemsnittet for anden klasse er: " + avg1/20);
